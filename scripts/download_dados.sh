...
# 1. Download GRCh38 reference genome (with decoy and HLA)
echo "Downloading reference genome (GRCh38 + decoy + HLA)..."
...
echo "Downloading alignment files (CRAM and CRAI)..."
...
echo "Downloading BED file (Twist Exome v2.0.2)..."
wget -c --progress=bar:force \
...
echo "Downloading VCF file and its index (HapMap 3.3, hg38)..."
wget -c --progress=bar:force \
...
# 5. Check file integrity (MD5 hashes)
echo "Verifying file integrity with MD5..."
...
cd ..
echo "Download, indexing and verification completed successfully!"
